    ...
    <header className={cx('header', { scrolled: isScrolled, mobile: isMobileMenuOpen })}>
      <div className={cx('headerWrapper', 'container', { mobile: isMobileMenuOpen })}>
        <div className={cx('headerInner')}>
          <Link to="/#banner" className={cx('headerLogo')} onClick={closeMobileMenu}>
            Moscow Gurman
          </Link>
          <button
        ...
        <nav className={cx('headerNav', { mobile: isMobileMenuOpen })}>
          <Link to="/#gallery" className={cx('headerNav-link')} onClick={closeMobileMenu}>
            Галерея
          </Link>
        ...
        <nav className={cx('headerNav', { mobile: isMobileMenuOpen })}>
          <a className={cx('headerPhone')} href="tel:+7(999)999-99-99">
            +7 (999) 999-99-99
          </a>
          <SocialIcon width={'30'} />
        </nav>
